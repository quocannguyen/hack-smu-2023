...
export interface IDAppAddressRelayInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "getInputBox" | "relayDAppAddress"): FunctionFragment;
    encodeFunctionData(functionFragment: "getInputBox", values?: undefined): string;
    encodeFunctionData(functionFragment: "relayDAppAddress", values: [string]): string;
    decodeFunctionResult(functionFragment: "getInputBox", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "relayDAppAddress", data: BytesLike): Result;
    events: {};
}
export interface IDAppAddressRelay extends BaseContract {
    ...
    functions: {
        ...
        relayDAppAddress(_dapp: string, overrides?: Overrides & {
            from?: string;
